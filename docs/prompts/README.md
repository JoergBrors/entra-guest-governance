...
offenen Punkte gab es. Die Prompts selbst liegen unverändert in `../../prompts/`
(Codex-Prompts) bzw. sind im jeweiligen Dokument referenziert.

| # | Datum | Prompt | Zusammenfassung |
| --- | --- | --- | --- |
| 01 | 2026-08-28 | `prompts/01-bootstrap-mvp.md` | [01-bootstrap-mvp.md](01-bootstrap-mvp.md) |
| 02 | 2026-08-28 | `prompts/02-test-mvp.md` | [02-test-mvp.md](02-test-mvp.md) |
